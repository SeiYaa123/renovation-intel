...
module.exports = [
  {
    ...
    type: "product",
    fetch: async () => {
      // TODO: remplacer par parsing API/RSS/CSV si disponible
      // Pour MVP, on retourne une liste “seed” statique
      return [
        {
          name: "BENOR",
          summary:
            "Marquage de conformité belge pour produits de construction.",
    ...
    fetch: async () => [
      {
        ...
        summary:
          "Certification des installateurs d’énergies renouvelables (PV, PAC, solaire).",
